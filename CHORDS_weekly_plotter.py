...
#This code reads data from the UCAR/NCAR COMET 3D-PAWS downloaded from CHORDS
#    and generates plots on a weekly basis.
#
...
#           directory
#           site_ID
#           var_name: HTU21D_T, HTU21D_RH, BMP280_SLP, BMP280_SP, BMP280_T,
#                     MCP9808_T, windspeed, winddirection, precip,
#                     SI1145_VIS, SI1145_IR, SI1145_UV, battery_voltage, gust,
#                     gust_direction, soil_moisture1, soil_moisture2,
#                     soil_moisture3, soil_T1, soil_T2,
#                     soil_T3, soil_battery
#           save_dir
#           wildcard
#           mintime
#           maxtime
#    2. Run with "python CHORDS_weekly_plotter.py" in terminal, or open in
...
save_dir = "/Users/blund/Documents/3D-PAWS/Data/3DPAWS_Martin_Station/"
...
if var_name == "alt" or var_name == "temp_C" or var_name == "temp_F" or \
    var_name == "SLP_hPa" or var_name == "SLP_inHg" or var_name == "station_P":
    pass
else:
