...
#           freq: an integer greater than 0
#           save_dir
#           wildcard
#           mintime: "YYYY-MM-DD HH:mm"
#           maxtime: "YYYY-MM-DD HH:mm"
...
for w in range(start,end,interval):
    ...
    #plt.gca().xaxis.set_major_formatter(mdates.AutoDateFormatter(locator, tz=None, defaultfmt='%b %d %Y'))
