...
#This code reads and plots data from the UCAR/NCAR COMET 3D-PAWS system SI1145
#    radiation sensor.
#
...
#           wildcard
#           tag
#    2. Run with "python SI1145_reader-plotter.py" in terminal, or open in
...
#
#       e.g. if var_name == "vis":
#                plt.savefig('%s%s_SI1145_vis.png' % (save_dir, site_ID), dpi=500, \
#                bbox_inches='tight')
#
...
directory = "/Users/blund/Documents/3D-PAWS/Data/WMO_HIGHWAY_01/data/si1145/"
...
num_lines = 0 #counts the number of lines read in
...
missing_reports = df.vis[mintime:maxtime].isna().sum()
