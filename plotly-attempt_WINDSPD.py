...
if units == "mps": #plot wind speed in meters per second
    ax = df.plot(x='time', y='wind_speed', color='b', label='wind_mps',
                  figsize=(30,5))
    ...
    ax = df.plot(x='time', y='wind_speed', color='b', label='wind_kmph', figsize=(30,5))
    ...
    ax = df.plot(x='time', y='wind_speed', color='b', label='wind_mph', figsize=(30,5))
    ...
    ax = df.plot(x='time', y='wind_speed', color='b', label='wind_kts', figsize=(30,5))
    ...
    print("Variable name not found. Check the spelling of 'units'. Program exiting...")
    sys.exit()
