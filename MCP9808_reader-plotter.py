...
#This code reads and plots data from the UCAR/NCAR COMET 3D-PAWS system MCP9808
#    temperature sensor.
#
...
#           directory
#           site_ID
#           var_name: temp_C, temp_F
#           save_dir
#           wildcard
#           tag
#    2. Run with "python MCP9808_reader-plotter.py" in terminal, or open in
...
directory = "/Users/blund/Documents/3D-PAWS/Data/WMO_HIGHWAY_01/data/mcp9808/"
...
lines = [] #to collect each line read in
