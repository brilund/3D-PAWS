...
for station in folder_list:
    ...
    for subfolder,sensor in tuple_lst:
        ...
        check_inputs = input_checker(sensor, var_name, units, averaged, avg_window, convert)
        ...
        ''' Need to decide if I will provide the user with the option to
            call specific functions from within the QA procedure.
            Additionally, adding all the flag columns to the dataframe
